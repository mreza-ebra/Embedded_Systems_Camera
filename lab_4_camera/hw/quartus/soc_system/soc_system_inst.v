	soc_system u0 (
		.camera_controller_0_conduit_end_data        (<connected-to-camera_controller_0_conduit_end_data>),        // camera_controller_0_conduit_end.data
		.camera_controller_0_conduit_end_frame_valid (<connected-to-camera_controller_0_conduit_end_frame_valid>), //                                .frame_valid
		.camera_controller_0_conduit_end_line_valid  (<connected-to-camera_controller_0_conduit_end_line_valid>),  //                                .line_valid
		.camera_controller_0_conduit_end_clk         (<connected-to-camera_controller_0_conduit_end_clk>),         //                                .clk
		.camera_controller_0_conduit_end_cam_reset_n (<connected-to-camera_controller_0_conduit_end_cam_reset_n>), //                                .cam_reset_n
		.camera_controller_0_conduit_end_cam_trigger (<connected-to-camera_controller_0_conduit_end_cam_trigger>), //                                .cam_trigger
