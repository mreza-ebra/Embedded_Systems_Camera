...
entity FullSystem is
    ...
    port(
        ...
        masteraddress: out std_logic_vector(31 downto 0);
...
architecture Testing of FullSystem is
	 ...
	 signal MasterWriteDataTemp : std_logic_vector(31 downto 0);
     signal FifoWords : std_logic_vector(8 downto 0);
     signal empty: std_logic;
	 constant CBURST : STD_LOGIC_VECTOR(7 downto 0) := X"A0";
...
begin
    ...
    SecondFifo: FIFO_32512 port map(clock=>clk, data=>outputColor, rdreq=>ReadFifo, wrreq=>ReadyOutColor,q=>MasterWriteDataTemp, empty=>empty, full=>full, usedw=>FifoWords);
